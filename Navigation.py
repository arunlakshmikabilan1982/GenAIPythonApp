...
#     st.markdown(hide_st_style,unsafe_allow_html=True)
    ...
    init_session_state()
    st.set_page_config(page_title="AI Copilot for Platform Development", page_icon="🤖")    
    ...
    if option == 'REQUIREMENT AI':
        ...
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="Auto_story_generator?option=REQUIREMENT AI" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/5968/5968875.png" width="45px" height="45px" style="margin-right: 10px;">User Story Creation</a>',unsafe_allow_html=True)
        ...
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="UI_to_UX_CodeGenerator?option=DEVELOPMENT AI" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/11987/11987364.png" width="45px" height="45px" style="margin-right: 10px;">Design to UI Code Generation</a>',unsafe_allow_html=True)
