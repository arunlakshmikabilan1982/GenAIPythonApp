...
#     st.markdown(hide_st_style,unsafe_allow_html=True)
    ...
    if option == 'REQUIREMENT AI':
        ...
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="Conversational_AI?option=REQUIREMENT AI" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/11083/11083341.png" width="45px" height="45px" style="margin-right: 10px;">Auto Pre-Sales Analysis</a>',unsafe_allow_html=True)
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="Conversational_AI?option=REQUIREMENT AI" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/5968/5968875.png" width="45px" height="45px" style="margin-right: 10px;">JIRA Story Creation</a>',unsafe_allow_html=True)
