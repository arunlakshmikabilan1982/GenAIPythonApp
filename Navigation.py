...
def sidebar():
    ...
    option = st.sidebar.selectbox('', ['REQUIREMENT AI', 'CONTENT AI','DEVELOPMENT AI'])
    ...
    if option == 'REQUIREMENT AI':
        ...
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="/Train_Your_Own_Data" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/3270/3270865.png" width="45px" height="45px" style="margin-right: 10px;">Train Your Own Data</a>',unsafe_allow_html=True)
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="/Content_Generator" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/11100/11100117.png" width="45px" height="45px" style="margin-right: 10px;">Content Generator</a>',unsafe_allow_html=True)
        ...
        st.sidebar.markdown('<a style="color: #FFFF ; font-size: 16px; text-decoration: none; display: flex; align-items: center; padding: 8px 0;" href="/Language_Translator_in_file" target="_self"><img src="https://cdn-icons-png.flaticon.com/128/5798/5798224.png" width="45px" height="45px" style="margin-right: 10px;"> Language Translator with File</a>',unsafe_allow_html=True)
